...
module.exports = {
  ...
  create(context) {
    ...
    function optionsForNode(node) {
      ...
      console.log('XXX: ImportDetails:', importDetails);

      if (importDetails == null) {
        return defaultOptions;
      }

      console.log('XXX: SOURCE:', importDetails.source);
      console.log('XXX: NAME:', importDetails.name);

      const foundModule = modules[importDetails.source];

      console.log('XXX: foundModule:', foundModule);
